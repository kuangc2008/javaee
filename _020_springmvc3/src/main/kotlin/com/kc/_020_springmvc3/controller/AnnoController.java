package com.kc._020_springmvc3.controller;


import com.kc._020_springmvc3.domain.User;
...
public class AnnoController {
    ...
    public String testRequestParam(@RequestParam(name="name") String username){
        System.out.println("执行了111111111...");
    ...
    public void showUser(String uname, Map<String,User> map){
        System.out.println("showUser执行了22222222...");
        // 通过用户查询数据库（模拟）
        User user = new User();
        user.setUname(uname);
        user.setAge(20);
